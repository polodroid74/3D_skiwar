...
TexturedMeshRenderable::TexturedMeshRenderable(ShaderProgramPtr shaderProgram,
        ...
        float radius, glm::vec3 translation, bool Fixed) :
...
//----------------------collisions-----------------------------
float TexturedMeshRenderable::getRadius() const
{
  return m_radius;
}
void TexturedMeshRenderable::setRadius(const float& radius){
  this->m_radius=radius;
}
collisionSphere* TexturedMeshRenderable::computeCollisionSphere(){
  collisionSphere *cs = new collisionSphere(this->translation,this->getRadius());
        return cs;
}

const glm::vec3& TexturedMeshRenderable::getPosition() const
{
