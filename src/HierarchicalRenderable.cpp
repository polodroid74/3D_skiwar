...
collisionSphere* HierarchicalRenderable::computeCollisionSphere()
{
  collisionSphere *cs = new collisionSphere(glm::vec3(0,0,0),0.0);
  return cs;
}

float HierarchicalRenderable::getMass() const
{
  return 10.0;
}
bool HierarchicalRenderable::isFixed() const
{
  return true;
}

void HierarchicalRenderable::setVelocity(const glm::vec3 &vel)
{
  //ne fait rien
}
float HierarchicalRenderable::getRadius() const
{
  return 1.0;
}
void HierarchicalRenderable::setPosition(const glm::vec3 &pos)
{
  //ne fait rien
}

const glm::vec3& HierarchicalRenderable::getPosition() const
{
 ...
 */
const glm::vec3& HierarchicalRenderable::getVelocity() const
{
  return this->vitesse;
}
