...
{
    //Initialize geometry
    teachers::getUnitCylinder(m_positions, m_normals, m_texCoords , 5);
...
void SkyBox::setPosition(const double x, const double y)
{
	m_posx = x;
	m_posy = y;
}
...
void SkyBox::do_draw()
{
	...
	auto parentTransformation = glm::translate(glm::mat4(1.0), glm::vec3(m_posx, m_posy, -50.0));
