...
KeyframedEpineRenderable::KeyframedEpineRenderable(
        ShaderProgramPtr prog) //, const MaterialPtr& material)
    : EpineRenderable(prog) //, material)
{
}
...
void KeyframedEpineRenderable::addParentTransformKeyframe(float time, const GeometricTransformation& transformation)
{
    m_parentKeyframes.add(time, transformation);
}

void KeyframedEpineRenderable::addLocalTransformKeyframe(float time, const GeometricTransformation& transformation)
{
    m_localKeyframes.add(time, transformation);
}

void KeyframedEpineRenderable::do_animate(float time)
{
