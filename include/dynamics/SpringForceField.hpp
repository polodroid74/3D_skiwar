...
public:
     ...
     *
     *  Build a new spring force field between two meshes.
...
private:
    /**@brief Add the force of this spring to the two meshes.
     *
     * Compute the forces applied by this spring to each meshes
     * and add them to the meshes.
     */
    void do_addForce();
