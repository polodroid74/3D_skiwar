 ...
 *
 * This class represents a dynamic system made of meshes, force fields and
...
{
private:
    /**@brief The set of meshes managed by this system.
     *
     * The meshes managed by this dynamic system. Their positions
     * and velocities will be updated thanks to the solver, taking into
     * account the force field applied to them.
     */
    std::vector<TexturedMeshRenderablePhysicPtr> m_TexturedMeshRenderablePhysic;
    std::vector<HierarchicalRenderablePtr> m_meshes;

    /**@brief The set of force fields influencing meshes of this system.
     *
     * The force fields that influence the meshes of this system.
     */
    std::vector<ForceFieldPtr> m_forceFields;

    /**@brief The set of fixed plane obstacles.
     *
     * The set of obstacles that would repel the meshes after collisions.
     */
    std::vector<PlanePtr> m_planeObstacles;

    /**@brief The solver of the dynamic system.
     *
     * Solver of the dynamic system: update the meshes positions and
...
public:
     ...
     */
    void addMesh(HierarchicalRenderablePtr m);
    /**@brief Add a force field to the system.
     *
     * Add a force field to this dynamic system to influence meshes.
     * @param forceField The force field to add to this system.
     */

    void addTexturedMeshRenderablePhysic(TexturedMeshRenderablePhysicPtr p); //RAJOUT
     ...
     * are activated, this plane will repel meshes.
    ...
    /**@brief Access to the set of meshes of this system.
     *
     * Get the set of meshes of this dynamic system.
     * @return The set of meshes of this system.
     */
    const std::vector<HierarchicalRenderablePtr>& getmeshes() const;

    /**@brief Set the meshes of this system.
     *
     * Define a new set of meshes for this dynamic system.
     * @param meshes The new set of meshes of this system.
     */
    void setmeshes(const std::vector<HierarchicalRenderablePtr> & meshes);
     ...
     *
     * Clear the system, i.e. empty the meshes, force fields and plane obstacles.
     */
    void clear();
