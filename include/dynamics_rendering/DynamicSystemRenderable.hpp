...
private:
     ...
     * new positions and velocities of the meshes. This update will be
     ...
     * If the key T is pressed, meshes are titled in random directions.
     * If the key F5 is pressed, the meshes are restarted.
